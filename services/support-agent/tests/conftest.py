"""
Test configuration and shared fixtures for the Support Agent.

Uses an in-process SQLite database (no real PostgreSQL) so tests run
without any external services. Outbound calls to booking/payment/RAG are
mocked per-test with respx or unittest.mock.
"""
import asyncio
