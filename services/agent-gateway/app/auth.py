...
auth.py
~~~~~~~
JWT decode-only utility for the agent gateway.
Tokens are issued by the user-service; we only validate them here.
Copied verbatim from booking-service/app/auth.py so tokens validate
...
async def get_bearer_token(
    ...
    """Returns the raw bearer token string (for forwarding to Support Agent)."""
