...
async def lifespan(app: FastAPI):
    log.info("analytics_service_startup", service=settings.service_name)
    await init_db()
    ...
    try:
        ...
        pass
    log.info("analytics_service_shutdown", service=settings.service_name)


app = FastAPI(
    title="TicketFlow Analytics Service",
    description="Consumes booking.events and aggregates simple counts.",
    version="1.0.0",
    lifespan=lifespan,
)
